...
class RangeSensor: public GameObject
{
  protected:
    ...
    //column 1: analog reading
    //column 2: distance in cm
    int calibrationData[12][2]= {{0,200},{94,70},{110,60},{126,50},{149,40},{188,30},{268,20},{305,17},{341,15},{414,12},{487,10},{638,7}};

    //turns analog reading into distance by interpolating from empirical data
  ...
  //returns distance from range sensor
  float getDistance()
  {
